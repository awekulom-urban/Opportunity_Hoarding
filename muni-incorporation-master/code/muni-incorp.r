...
fips_crosswalk =
  read_csv(
    "Data/muni-incorporation-master/rawdata/fips-crosswalk.csv",
    col_types = cols(
...
muni_incorp =
  read_csv(
    "Data/muni-incorporation-master/rawdata/muni-incorporation.csv",
    col_types = cols(
      census_id_pid6 = col_double(),
      muniname = col_character(),
      statename = col_character(),
...
muni_incorp_full =
  ...
  relocate(yr_incorp, .before = geoid) # was geometry changing to geoid
